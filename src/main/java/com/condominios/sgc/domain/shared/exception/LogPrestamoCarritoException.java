...
public class LogPrestamoCarritoException extends DominioException {
    ...
    public static LogPrestamoCarritoException solicitanteInvalido() {
        return new LogPrestamoCarritoException("debe especificarse exactamente un propietario o un inquilino");
    }
