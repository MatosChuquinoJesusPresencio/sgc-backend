...
public class LogPrestamoCarritoModel {
    ...
    public LogPrestamoCarritoModel(TipoHabitante solicitante, String nombreSolicitante, 
            String dniSolicitante, Long idApartamento, Long idCarrito) {
        this.id = null;
        this.solicitante = noNulo(solicitante, LogPrestamoCarritoException::solicitanteRequerido);
