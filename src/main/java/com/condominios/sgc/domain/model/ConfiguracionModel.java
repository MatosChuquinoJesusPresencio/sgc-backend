...
public class ConfiguracionModel {
    ...
    public ConfiguracionModel(Long id, Integer maxAutos, Integer maxMotos, BigDecimal penalizacionPorMin,
    ...
    public void asignarCondominio(Long idCondominio) {
        this.idCondominio = noNulo(idCondominio, ConfiguracionException::condominioRequerido);
    }
