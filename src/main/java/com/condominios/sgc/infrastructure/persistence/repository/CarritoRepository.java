...
public interface CarritoRepository extends JpaRepository<CarritoEntity, Long>, JpaSpecificationExecutor<CarritoEntity> {
    Optional<CarritoEntity> findByCodigo(String codigo);
    List<CarritoEntity> findByIdCondominio(Long idCondominio);
    List<CarritoEntity> findByEstado(EstadoCarrito estado);
}
