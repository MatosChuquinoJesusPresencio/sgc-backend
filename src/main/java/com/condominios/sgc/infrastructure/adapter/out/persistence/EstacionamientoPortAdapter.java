...
@Component
public class EstacionamientoPortAdapter implements EstacionamientoRepositoryPort {

    private final EstacionamientoJpaRepository repository;

    public EstacionamientoPortAdapter(EstacionamientoJpaRepository repository) {
